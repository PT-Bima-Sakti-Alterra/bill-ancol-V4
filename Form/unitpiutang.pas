...
procedure Tupiutang.refreshClick(Sender: TObject);
begin
  Qrek.close;
  Qrek.SQL.Clear;
  Qrek.SQL.Add(Qrek.SQLRefresh.Text);
  Qrek.ParamByName('nosamb').AsString:=DM.xnosamb;
  Qrek.Open;
end;

procedure Tupiutang.Action1Execute(Sender: TObject);
begin
close;
end;
