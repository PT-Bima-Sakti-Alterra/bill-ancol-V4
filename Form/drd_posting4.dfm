object udrd_posting4: Tudrd_posting4
  Left = 508
  Top = 135
  BorderStyle = bsNone
  Caption = 'DRD'
  ...
  object Qrek: TMyQuery
    ...
    SQL.Strings = (
        ...
        'select c.*,p.nama,p.alamat,r.namarayon,p.norumah FROm drdposting' +
        '201706 c LEFT JOIN pelanggan p ON c.nosamb=p.nosamb LEFT JOIN ra' +
        'yon r ON c.koderayon=r.koderayon ORDER BY CAST(c.koderayon AS UN' +
        'SIGNED),c.nosamb ASC limit 200')
    Active = True
    Left = 592
    Top = 139
  end
  ...
  object report: TfrxReport
    ...
    ReportOptions.LastChange = 42945.000326412040000000
