...
var
  udrd_posting4: Tudrd_posting4;

implementation

{$R *.dfm}  uses Module,Dateutils, UnitCombo, UnitMain, RzStatus;

procedure Tudrd_posting4.cxButton1Click(Sender: TObject);
var
keterangan:String;
begin
...
procedure Tudrd_posting4.FormShow(Sender: TObject);
begin
...
procedure Tudrd_posting4.cxButton2Click(Sender: TObject);
begin
close;
end;

procedure Tudrd_posting4.kodegolPropertiesChange(Sender: TObject);
begin
golongan.ItemIndex:=kodegol.ItemIndex;
end;

procedure Tudrd_posting4.koderayonPropertiesChange(Sender: TObject);
begin
 namarayon.ItemIndex:=koderayon.ItemIndex;
end;

procedure Tudrd_posting4.namarayonPropertiesChange(Sender: TObject);
begin
koderayon.ItemIndex:=namarayon.ItemIndex;
end;

procedure Tudrd_posting4.kodewilPropertiesChange(Sender: TObject);
begin
wilayah.ItemIndex:=kodewil.ItemIndex;
end;

procedure Tudrd_posting4.wilayahPropertiesChange(Sender: TObject);
begin
...
procedure Tudrd_posting4.kodekelurahanPropertiesChange(Sender: TObject);
begin
kelurahan.ItemIndex:=kodekelurahan.ItemIndex;
end;

procedure Tudrd_posting4.kelurahanPropertiesChange(Sender: TObject);
begin
kodekelurahan.ItemIndex:=kelurahan.ItemIndex;
end;

procedure Tudrd_posting4.kodecabangPropertiesChange(Sender: TObject);
begin
cabang.ItemIndex:=kodecabang.ItemIndex;
end;

procedure Tudrd_posting4.cabangPropertiesChange(Sender: TObject);
begin
...
procedure Tudrd_posting4.golonganPropertiesChange(Sender: TObject);
begin
kodegol.ItemIndex:=golongan.ItemIndex;
end;

procedure Tudrd_posting4.FormCreate(Sender: TObject);
begin
periode.date:=EncodeDateTime(YearOf(date), MonthOf(date), 5, 1, 2, 3, 4);
end;

procedure Tudrd_posting4.cekpemakaianClick(Sender: TObject);
begin
  if(cekpemakaian.Checked=true)then
  begin
...
procedure Tudrd_posting4.cekkodegolClick(Sender: TObject);
begin
 if(cekkodegol.Checked=true)then
  begin
...
procedure Tudrd_posting4.cekrayonClick(Sender: TObject);
begin
if(cekrayon.Checked=true)then
  begin
...
procedure Tudrd_posting4.cekwilClick(Sender: TObject);
begin
if(cekwil.Checked=true)then
  begin
...
procedure Tudrd_posting4.cekloketClick(Sender: TObject);
begin
if(cekloket.Checked=true)then
  begin
...
procedure Tudrd_posting4.kodeloketPropertiesChange(Sender: TObject);
begin
loket.ItemIndex:=kodeloket.ItemIndex;
end;

procedure Tudrd_posting4.loketPropertiesChange(Sender: TObject);
begin
kodeloket.ItemIndex:=loket.ItemIndex;
end;

procedure Tudrd_posting4.cekbayarClick(Sender: TObject);
begin
  if(cekbayar.Checked=true)then
  begin
      bayar.Enabled:=true;
...
procedure Tudrd_posting4.cekkolektifClick(Sender: TObject);
begin
if(cekkolektif.Checked=true)then
  begin
...
procedure Tudrd_posting4.kodekolektifPropertiesChange(Sender: TObject);
begin
kolektif.ItemIndex:=kodekolektif.ItemIndex;
end;

procedure Tudrd_posting4.kolektifPropertiesChange(Sender: TObject);
begin
kodekolektif.ItemIndex:=kolektif.ItemIndex;
end;

procedure Tudrd_posting4.F5Execute(Sender: TObject);
begin
  report.LoadFromFile(GetCurrentDir+'\report\drd.fr3');
  report.DesignReport(true);
end;

procedure Tudrd_posting4.cekcabangClick(Sender: TObject);
begin
if(cekcabang.Checked=true)then
  begin
...
procedure Tudrd_posting4.kodeareaPropertiesChange(Sender: TObject);
begin
area.ItemIndex:=kodearea.ItemIndex;
end;

procedure Tudrd_posting4.areaPropertiesChange(Sender: TObject);
begin
kodearea.ItemIndex:=area.ItemIndex;
end;

procedure Tudrd_posting4.cekareaClick(Sender: TObject);
begin
if(cekarea.Checked=true)then
  begin
...
procedure Tudrd_posting4.kodeflagPropertiesChange(Sender: TObject);
begin
flag.ItemIndex:=kodeflag.ItemIndex;
end;

procedure Tudrd_posting4.flagPropertiesChange(Sender: TObject);
begin
kodeflag.ItemIndex:=flag.ItemIndex;
end;

procedure Tudrd_posting4.cekflagClick(Sender: TObject);
begin
if(cekflag.Checked=true)then
  begin
