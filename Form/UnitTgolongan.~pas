...
type
  TFGolongan = class(TForm)
    ...
    cxLabel4: TcxLabel;
    cxLabel3: TcxLabel;
    dendatunggakan2: TcxCurrencyEdit;
    cxLabel21: TcxLabel;
    cxLabel34: TcxLabel;
    dendatunggakan3: TcxCurrencyEdit;
    cxLabel35: TcxLabel;
    dendatunggakanperbulan: TcxCurrencyEdit;
    cxLabel36: TcxLabel;
    retribusipakai: TcxCurrencyEdit;
    cxLabel37: TcxLabel;
    dendatunggakan4: TcxCurrencyEdit;
    cxButton2: TcxButton;
    cxLabel11: TcxLabel;
    bb1: TcxCurrencyEdit;
    ba1: TcxCurrencyEdit;
    ...
    cxLabel17: TcxLabel;
    cxLabel18: TcxLabel;
    mindenda: TcxCurrencyEdit;
    cxLabel19: TcxLabel;
    trf_denda_persen: TcxComboBox;
...
procedure TFGolongan.cxButton2Click(Sender: TObject);
begin
close;
end;

procedure TFGolongan.buttonClick(Sender: TObject);
var
j:integer;
begin
       ...
       TRY
        ...
        begin
          ...
          DM.Qcek.Close;
          DM.Qcek.SQL.Clear;
          DM.Qcek.SQL.Add('select * from golongan where kodegolyangberlaku=:kodegolyangberlaku');
          ...
          begin
              ...
              Umain.Qhost1.close;
              Umain.Qhost1.SQl.Clear;
              Umain.Qhost1.SQL.Add('replace into golongan (kodegolyangberlaku,periodemulaiberlaku,kodegol,golongan,aktif,kategori,bb1,ba1,bb2,ba2,bb3,ba3,bb4,ba4,bb5,ba5,t1,t2,t3,t4,t5) ');
              Umain.Qhost1.SQL.Add('values (:kodegolyangberlaku,:periodemulaiberlaku,:kodegol,:golongan,:aktif,:kategori,:bb1,:ba1,:bb2,:ba2,:bb3,:ba3,:bb4,:ba4,:bb5,:ba5,:t1,:t2,:t3,:t4,:t5)');
              ...
              DM.Qexec.ParamByName('administrasi').AsCurrency := adm.Value;
              ...
              DM.Qexec.ParamByName('dendapakai0').AsCurrency := denda0.Value;
              DM.Qexec.ParamByName('minpakai').AsCurrency := minpakai.Value;
              DM.Qexec.ParamByName('dendatunggakan').AsCurrency := dendatunggakan.Value;
              DM.Qexec.ParamByName('dendatunggakan2').AsCurrency := dendatunggakan2.Value;
              DM.Qexec.ParamByName('dendatunggakan3').AsCurrency := dendatunggakan3.Value;
              DM.Qexec.ParamByName('dendatunggakan4').AsCurrency := dendatunggakan4.Value;
              DM.Qexec.ParamByName('dendatunggakanperbulan').AsCurrency := dendatunggakanperbulan.Value;
              DM.Qexec.ParamByName('ppn').AsCurrency := ppn.Value;
              DM.Qexec.ParamByName('retribusipakai').AsCurrency := retribusipakai.Value;
              if(aktif.ItemIndex=0)then
              ...
              DM.Qexec.ParamByName('mindenda').AsCurrency := mindenda.Value;
              DM.Qexec.ParamByName('trf_denda_persen').AsString:=IntToStr(trf_denda_persen.ItemIndex);
              DM.Qexec.Execute;


              DM.uraianlogakses:='Tambah Golongan '+kode.Text;
        ...
        ELSE begin
              ...
              Umain.Qhost1.close;
              Umain.Qhost1.SQl.Clear;
              Umain.Qhost1.SQL.Add('update golongan set golongan=:golongan,aktif=:aktif,kategori=:kategori,bb1=:bb1,ba1=:ba1,bb2=:bb2,ba2=:ba2,bb3=:bb3,ba3=:ba3,bb4=:bb4,ba4=:ba4,bb5=:bb5,ba5=:ba5,t1=:t1,t2=:t2,t3=:t3,t4=:t4,t5=:t5 where kodegolyangberlaku=:kodegolyangberlaku');
              Umain.Qhost1.ParamByName('kodegolyangberlaku').AsString:=FormatDateTime('YYYYMM',periode.date)+'.'+TRIM(kode.Text);
              Umain.Qhost1.ParamByName('golongan').AsString:=TRIM(golongan.Text);
              Umain.Qhost1.ParamByName('kategori').AsString:=TRIM(kategori.Text);
...
procedure TFGolongan.FormClose(Sender: TObject; var Action: TCloseAction);
begin
kode.Text:='';
golongan.Text:='';
nomorba.Text:='';
...
dendatunggakan2.Value:=0;
dendatunggakan3.Value:=0;
dendatunggakanperbulan.Value:=0;
retribusipakai.Value:=0;
ppn.Value:=0;
minpakai.Value:=0;
aktif.ItemIndex:=0;
...
procedure TFGolongan.Action2Execute(Sender: TObject);
begin
close;
end;
