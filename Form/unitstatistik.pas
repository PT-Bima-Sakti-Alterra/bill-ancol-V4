...
procedure Tustatistik.cxButton2Click(Sender: TObject);
begin
close;
end;

procedure Tustatistik.cxButton1Click(Sender: TObject);
var
keterangan:String;
begin
...
procedure Tustatistik.FormShow(Sender: TObject);
begin
ucombo.isikombo();
...
procedure Tustatistik.koderayonPropertiesChange(Sender: TObject);
begin
namarayon.ItemIndex:=koderayon.ItemIndex;
end;

procedure Tustatistik.namarayonPropertiesChange(Sender: TObject);
begin
koderayon.ItemIndex:=namarayon.ItemIndex;
end;

procedure Tustatistik.FormCreate(Sender: TObject);
begin
periode.date:=EncodeDateTime(YearOf(date), MonthOf(date), 5, 1, 2, 3, 4);
end;

procedure Tustatistik.cekrayonClick(Sender: TObject);
begin
if(cekrayon.Checked=true)then
  begin
