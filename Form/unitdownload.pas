...
uses
  ...
  dxSkinOffice2013White, cxLabel, cxTextEdit, cxMaskEdit, cxDropDownEdit,
  cxCalendar, DB, MemDS, DBAccess, MyAccess, Menus, StdCtrls, cxButtons,
  cxCurrencyEdit, RzPrgres, cxSpinEdit, cxTimeEdit, cxMemo, ActnList,
  cxCheckBox,  ExtCtrls, RzPanel, dxSkinMetropolis, dxSkinMetropolisDark,
  dxSkinOffice2013DarkGray, dxSkinOffice2013LightGray, dxSkiniMaginary;

type
  Tudownload = class(TForm)
    Qhost1: TMyQuery;
    Qcek: TMyQuery;
    Qnonair: TMyQuery;
    Qlunas: TMyQuery;
...
var
  udownload: Tudownload;

implementation

uses UnitMain, Module, RzStatus, DateUtils, StrUtils;

{$R *.dfm}

procedure Tudownload.FormShow(Sender: TObject);
begin
...
procedure Tudownload.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure Tudownload.cxButton1Click(Sender: TObject);
var
j,i:integer;
        ...
        batallltt:=0;
                ...
                begin
                  ...
                  begin
                   ...
                   DM.Qexec.close;
                   DM.Qexec.SQL.Clear;
                   DM.Qexec.SQL.Add('REPLACE INTO setoran (kode,tanggal,kodeloket,penerimaan,bank1,bank2,bank3,bank4,tanggalsetor,namabank,keterangan,user,waktuupdate)');
                   DM.Qexec.SQL.Add('VALUES');
                   DM.Qexec.SQL.Add('(:kode,:tanggal,:kodeloket,:penerimaan,:bank1,:bank2,:bank3,:bank4,:tanggalsetor,:namabank,:keterangan,:user,:waktuupdate)');
                ...
                Qcek.Close;
                Qcek.SQL.Clear;
                Qcek.SQL.Add('(SELECT * FROM piutanglimbah WHERE waktuupdate> :tanggal)');
                Qcek.SQL.Add('UNION');
                Qcek.SQL.Add('(SELECT * FROM bayarlimbah WHERE waktuupdate> :tanggal) ORDER BY waktuupdate ASC');
                ...
                begin
                        ...
                        begin
                            ...
                            begin
                                 ...
                                 Dm.Qexec.close;
                                 Dm.Qexec.SQl.Clear;
                                 Dm.Qexec.SQL.Add('REPLACE INTO bayarlimbah'+FormatDateTime('YYYY',Qcek.fieldbyname('tglbayar').AsDateTime)+' (kode,periode,bulan,nomorlimbah,nosamb,kodelimbahyangberlaku,kodelimbah,koderayon,total,flaglunas,tglbayar,kasir,loketbayar,nolpp,flagpublish,flagaktif,flagkirim) VALUES');
                                 Dm.Qexec.SQL.Add(' (:kode,:periode,:bulan,:nomorlimbah,:nosamb,:kodelimbahyangberlaku,:kodelimbah,:koderayon,:total,:flaglunas,:tglbayar,:kasir,:loketbayar,:nolpp,:flagpublish,:flagaktif,:flagkirim)');
                                 Dm.Qexec.ParamByName('kode').AsString:=Qcek.fieldbyname('kode').AsString;
                            ...
                            begin
                                 ...
                                 Dm.Qexec.close;
                                 Dm.Qexec.SQl.Clear;
                                 Dm.Qexec.SQL.Add('REPLACE piutanglimbah (kode,periode,bulan,nomorlimbah,nosamb,kodelimbahyangberlaku,kodelimbah,koderayon,total,flaglunas,flagbatal,tglbatal,flagpublish,flagaktif,flagkirim) VALUES');
                                 Dm.Qexec.SQL.Add(' (:kode,:periode,:bulan,:nomorlimbah,:nosamb,:kodelimbahyangberlaku,:kodelimbah,:koderayon,:total,:flaglunas,:flagbatal,:tglbatal,:flagpublish,:flagaktif,:flagkirim)');
                                 Dm.Qexec.ParamByName('kode').AsString:=Qcek.fieldbyname('kode').AsString;
                                 Dm.Qexec.ParamByName('periode').AsString:=Qcek.fieldbyname('periode').AsString;
                                 Dm.Qexec.ParamByName('nomorlimbah').AsString:=Qcek.fieldbyname('nomorlimbah').AsString;
                                 Dm.Qexec.ParamByName('nosamb').AsString:=Qcek.fieldbyname('nosamb').AsString;
                                ...
                                DM.Qexec.close;
                                DM.Qexec.SQL.Clear;
                                DM.Qexec.SQL.Add('DELETE FROM bayarlimbah WHERE kode=:kode');
                                DM.Qexec.ParamByName('kode').AsString:=Qcek.fieldbyname('kode').AsString;
                                DM.Qexec.Execute;
                ...
                Qcek.Close;
                Qcek.SQL.Clear;
                Qcek.SQL.Add('(SELECT * FROM piutanglltt WHERE waktuupdate> :tanggal)');
                Qcek.SQL.Add('UNION');
                Qcek.SQL.Add('(SELECT * FROM bayarlltt WHERE waktuupdate> :tanggal) ORDER BY waktuupdate ASC');
                ...
                begin
                        ...
                        begin
                            ...
                            begin
                                 ...
                                 Dm.Qexec.close;
                                 Dm.Qexec.SQl.Clear;
                                 Dm.Qexec.SQL.Add('REPLACE INTO bayarlltt'+FormatDateTime('YYYY',Qcek.fieldbyname('tglbayar').AsDateTime)+' (kode,periode,bulan,nomorlltt,nosamb,kodellttyangberlaku,kodelltt,koderayon,total,flaglunas,tglbayar,kasir,loketbayar,nolpp,flagpublish,flagaktif,flagkirim) VALUES');
                                 Dm.Qexec.SQL.Add(' (:kode,:periode,:bulan,:nomorlltt,:nosamb,:kodellttyangberlaku,:kodelltt,:koderayon,:total,:flaglunas,:tglbayar,:kasir,:loketbayar,:nolpp,:flagpublish,:flagaktif,:flagkirim)');
                                 Dm.Qexec.ParamByName('kode').AsString:=Qcek.fieldbyname('kode').AsString;
                                 Dm.Qexec.ParamByName('periode').AsString:=Qcek.fieldbyname('periode').AsString;
                            ...
                            begin
                                 ...
                                 Dm.Qexec.close;
                                 Dm.Qexec.SQl.Clear;
                                 Dm.Qexec.SQL.Add('REPLACE piutanglltt (kode,periode,bulan,nomorlltt,nosamb,kodellttyangberlaku,kodelltt,koderayon,total,flaglunas,flagbatal,tglbatal,flagpublish,flagaktif,flagkirim) VALUES');
                                 Dm.Qexec.SQL.Add(' (:kode,:periode,:bulan,:nomorlltt,:nosamb,:kodellttyangberlaku,:kodelltt,:koderayon,:total,:flaglunas,:flagbatal,:tglbatal,:flagpublish,:flagaktif,:flagkirim)');
                                 Dm.Qexec.ParamByName('kode').AsString:=Qcek.fieldbyname('kode').AsString;
                                 Dm.Qexec.ParamByName('periode').AsString:=Qcek.fieldbyname('periode').AsString;
                                 Dm.Qexec.ParamByName('nomorlltt').AsString:=Qcek.fieldbyname('nomorlltt').AsString;
                                 Dm.Qexec.ParamByName('nosamb').AsString:=Qcek.fieldbyname('nosamb').AsString;
                                ...
                                DM.Qexec.close;
                                DM.Qexec.SQL.Clear;
                                DM.Qexec.SQL.Add('DELETE FROM bayarlltt WHERE kode=:kode');
                                DM.Qexec.ParamByName('kode').AsString:=Qcek.fieldbyname('kode').AsString;
                                DM.Qexec.Execute;
                ...
                begin
                        ...
                        begin
                                      ...
                                      begin
                                                  ...
                                                  if(Qcek.fieldbyname('jenis').AsString='TUNGGAKAN')then
                                                  begin
                      ...
                      begin
                               ...
                               begin
                                 ...
                                 // CEK TABLE BAYAR TAHUN
                                    ...
                                    DM.Qexec.close;
                                    DM.Qexec.SQL.Clear;
                                    DM.Qexec.SQL.Add('delete from nonair where nomor=:nomor AND periode=:periode AND jenis IN ("DENDA","HPS.SCR.AKUTANSI")');
...
procedure Tudownload.cxButton2Click(Sender: TObject);
begin

close;
end;

procedure Tudownload.resetClick(Sender: TObject);
begin
...
procedure Tudownload.cekClick(Sender: TObject);
begin
