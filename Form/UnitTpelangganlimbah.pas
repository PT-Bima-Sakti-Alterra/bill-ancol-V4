...
type
  TUTpelangganlimbah = class(TForm)
    RzPanel1: TRzPanel;
    nama: TcxTextEdit;
    cxLabel2: TcxLabel;
    cxLabel3: TcxLabel;
...
var
  UTpelangganlimbah: TUTpelangganlimbah;

implementation

{$R *.dfm}  uses Module, UnitCombo,  UnitMain, StrUtils, unitloading;

procedure TUTpelangganlimbah.noClick(Sender: TObject);
begin
close;
end;

procedure TUTpelangganlimbah.koderayonPropertiesChange(Sender: TObject);
begin
...
procedure TUTpelangganlimbah.namarayonPropertiesChange(Sender: TObject);
begin
koderayon.ItemIndex:=namarayon.ItemIndex;
end;

procedure TUTpelangganlimbah.kodekolektifPropertiesChange(Sender: TObject);
begin
kolektif.ItemIndex:=kodekolektif.ItemIndex;
end;

procedure TUTpelangganlimbah.kolektifPropertiesChange(Sender: TObject);
begin
kodekolektif.ItemIndex:=kolektif.ItemIndex;
end;

procedure TUTpelangganlimbah.FormShow(Sender: TObject);
begin
...
procedure TUTpelangganlimbah.okClick(Sender: TObject);
var
j:integer;
lanjut:byte;
begin
       ...
       DM.Qexec.Execute;
         ...
         begin
              ...
              Qnosamb.Open;
               ...
               begin
                ...
                exit;
                    ...
                    Umain.Qhost1.SQL.Add('(:nomorlimbah,:nosamb,:nama,:alamat,:kodelimbah,:koderayon,:kodekolektif,:status,:flag,:nopendaftaran,:norab,NOW(),:kodeblok,:luasrumah,:notelp,:nohp,:norumah,:rt,:rw)');
                   ...
                   begin
                    ...
                    begin
                         ...
                         umain.Qhost1.close;
                         umain.Qhost1.SQL.Clear;
                         umain.Qhost1.SQL.Add('update rab_limbah set nosambyangdiberikan=:nosambyangdiberikan,kodelimbah=:kodelimbah,kodediameter=:kodediameter,koderayon=:koderayon,flagaktif="1",waktupengaktifan=NOW(),flagprosesdata="1",nosamb=:nosamb WHERE norab=:norab');
                         umain.Qhost1.ParamByName('norab').AsString:=znorab;
           ...
           begin
              ...
              Qnosamb.Close;
              Qnosamb.SQL.Clear;
              Qnosamb.SQL.add('select * FROm nosamb_limbah WHERE  nomor=:nomor and nama<>:nama');
              Qnosamb.ParamByName('nomor').AsString:=nomor.Text;
              ...
              begin
                MessageDlg('Nomor Limbah Sudah digunakan oleh pelanggan '+Qnosamb.fieldbyname('nama').AsString+' !!!', mtWarning, [mbOK], 0);
                exit;
             end;
                            ...
                            Umain.Qhost1.close;
                            Umain.Qhost1.SQL.Clear;
                            Umain.Qhost1.SQL.Add('update pelanggan_limbah set');
                            ...
                            Umain.Qhost1.SQL.add('where nomorlimbah=:nomorlimbah');
                            Umain.Qhost1.ParamByName('nomorlimbah').AsString:=nomor.Text;
                            Umain.Qhost1.ParamByName('kodekolektif').AsString:=kodekolektif.Text;
                            Umain.Qhost1.ParamByName('luasrumah').AsCurrency:=luasrumah.Value;
                            Umain.Qhost1.ParamByName('notelp').AsString:=telp.Text;
                            ...
                            DM.Qexec.close;
                            DM.Qexec.SQL.Clear;
                            DM.Qexec.SQL.Add('update pelanggan_limbah set nomorlimbah=:nomorlimbah,nosamb=:nosamb,');
                            DM.Qexec.SQL.add('nama=:nama,alamat=:alamat,kodelimbah=:kodelimbah,');
                            ...
                            DM.Qexec.SQL.add('where nomorlimbah=:nomorlimbahlama');
                            DM.Qexec.ParamByName('nomorlimbahlama').AsString:=DM.Xnomorlimbah;
                            DM.Qexec.ParamByName('nomorlimbah').AsString:=nomor.Text;
                            DM.Qexec.ParamByName('nosamb').AsString:=nosamb.Text;
                            DM.Qexec.ParamByName('nama').AsString:=nama.Text;
                            DM.Qexec.ParamByName('alamat').AsString:=alamat.Text;
                            ...
                            DM.uraianlogakses:='Koreksi Pelanggan Limbah '+nomor.Text;
...
procedure TUTpelangganlimbah.cxButton1Click(Sender: TObject);
begin
...
procedure TUTpelangganlimbah.FormClose(Sender: TObject;
...
procedure TUTpelangganlimbah.kodekelurahanPropertiesChange(Sender: TObject);
begin
kelurahan.ItemIndex:=kodekelurahan.ItemIndex;
end;

procedure TUTpelangganlimbah.kelurahanPropertiesChange(Sender: TObject);
begin
kodekelurahan.ItemIndex:=kelurahan.ItemIndex;
end;

procedure TUTpelangganlimbah.kodeblokPropertiesChange(Sender: TObject);
begin
namablok.ItemIndex:=kodeblok.ItemIndex;
end;

procedure TUTpelangganlimbah.namablokPropertiesChange(Sender: TObject);
begin
kodeblok.ItemIndex:=namablok.ItemIndex;
end;

procedure TUTpelangganlimbah.RzPanel8MouseDown(Sender: TObject;
...
procedure TUTpelangganlimbah.cekhanyamelengkapidataClick(Sender: TObject);
begin
...
procedure TUTpelangganlimbah.kodelimbahPropertiesChange(Sender: TObject);
begin
golonganlimbah.ItemIndex:=kodelimbah.ItemIndex;
end;

procedure TUTpelangganlimbah.golonganlimbahPropertiesChange(
  Sender: TObject);
begin
