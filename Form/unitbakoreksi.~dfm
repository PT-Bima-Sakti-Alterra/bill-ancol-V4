object ubakoreksi: Tubakoreksi
  ...
  object rek: TfrxDBDataset
    ...
    FieldAliases.Strings = (
      ...
      'rekair=rekair'
      'kodegol2=kodegol2'
      'kodediameter2=kodediameter2'
      'stanlalu2=stanlalu2'
      'stanangkat2=stanangkat2'
      'stanskrg2=stanskrg2'
      'pakai2=pakai2'
      'biayapemakaian2=biayapemakaian2'
      'administrasi2=administrasi2'
      'pemeliharaan2=pemeliharaan2'
      'retribusi2=retribusi2'
      'meterai2=meterai2'
      'rekair2=rekair2'
      'nama=nama'
      'alamat=alamat'
  ...
  object Qrek: TMyQuery
    ...
    Left = 288
    Top = 235
    object Qrekberitaacara: TStringField
      FieldName = 'beritaacara'
      Origin = 'b.beritaacara'
      Size = 50
    end
    object Qrektglinput: TDateField
      FieldName = 'tglinput'
      Origin = 'b.tglinput'
    end
    object Qrekalasan: TStringField
      FieldName = 'alasan'
      Origin = 'b.alasan'
      Size = 100
    end
    ...
    object Qrekkodegol2: TStringField
      FieldName = 'kodegol2'
      Origin = 'c.kodegol'
      Size = 30
    end
    object Qrekkodediameter2: TStringField
      FieldName = 'kodediameter2'
      Origin = 'c.kodediameter'
      Size = 30
    end
    object Qrekstanlalu2: TFloatField
      FieldName = 'stanlalu2'
      Origin = 'c.stanlalu'
    end
    object Qrekstanangkat2: TFloatField
      FieldName = 'stanangkat2'
      Origin = 'c.stanangkat'
    end
    object Qrekstanskrg2: TFloatField
      FieldName = 'stanskrg2'
      Origin = 'c.stanskrg'
    end
    ...
    object Qrekbiayapemakaian2: TFloatField
      FieldName = 'biayapemakaian2'
      Origin = 'c.biayapemakaian'
    end
    object Qrekadministrasi2: TFloatField
      FieldName = 'administrasi2'
      Origin = 'c.administrasi'
    end
    object Qrekpemeliharaan2: TFloatField
      FieldName = 'pemeliharaan2'
      Origin = 'c.pemeliharaan'
    end
    object Qrekretribusi2: TFloatField
      FieldName = 'retribusi2'
      Origin = 'c.retribusi'
    end
    object Qrekmeterai2: TFloatField
      FieldName = 'meterai2'
      Origin = 'c.meterai'
    end
    object Qrekrekair2: TFloatField
      FieldName = 'rekair2'
      Origin = 'c.rekair'
    end
    ...
    object Qrekperhitungan: TStringField
      FieldName = 'perhitungan'
      Origin = 'b.perhitungan'
      Size = 50
    end
  end
  ...
  object ba1: TfrxReport
    ...
    ReportOptions.LastChange = 43167.821480763890000000
    ...
    object Page3: TfrxReportPage
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        object Memo51: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8 = (
            'BERITA ACARA PERUBAHAN REKENING AIR')
          ParentFont = False
        end
        ...
        object Memo27: TfrxMemoView
          ...
          Memo.UTF8 = (
              ...
              '       Pada hari ini, <b> [FormatDateTime('#39'dddd'#39',<rek."tglinput"' +
              '>)] </b> tanggal <b> [FormatDateTime('#39'dd'#39',<rek."tglinput">)] </b' +
              '> bulan <b> [FormatDateTime('#39'mmmm'#39',<rek."tglinput">)] </b> tahun' +
              ' <b> [FormatDateTime('#39'yyyy'#39',<rek."tglinput">)] </b> Kami selaku ' +
              'petugas  Opname Meter / Hubungan Langganan telah melakukan penge' +
              'cekan ulang terhadap pelanggan tersebut dibawah ini :')
          ParentFont = False
        end
  ...
  object ba2: TfrxReport
    ...
    PrintOptions.Reverse = True
    ReportOptions.CreateDate = 42030.464315972200000000
    ReportOptions.LastChange = 43167.870549282410000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      'begin'
      ''
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        object Memo27: TfrxMemoView
          ...
          Memo.UTF8 = (
              ...
              '>)] </b> tanggal <b> [FormatDateTime('#39'dd'#39',<rek."tglinput">)] </b' +
              '> bulan <b> [FormatDateTime('#39'mmmm'#39',<rek."tglinput">)] </b> tahun' +
              ' <b> [FormatDateTime('#39'yyyy'#39',<rek."tglinput">)] </b>. Berdasarkan' +
              ' laporan akurasi meter dari Bagian Tehnik dan Perawatan Meter ta' +
              'nggal .................. menerangkan bahwa pelanggan tersebut di' +
              'bawah ini :'
            ''
            ''
            '   ')
