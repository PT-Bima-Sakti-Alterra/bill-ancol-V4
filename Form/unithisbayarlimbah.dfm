object uhisbayarlimbah: Tuhisbayarlimbah
  Left = 1165
  Top = 165
  BorderStyle = bsNone
  ...
  object Qbayar: TMyQuery
    SQLRefresh.Strings = (
      ...
      ''
      'FROm bayarlimbah:tahun '
      'WHERE flaglunas="1" '
      'AND nomorlimbah=:nomorlimbah '
  ...
  object dxComponentPrinter1: TdxComponentPrinter
    ...
    object dxComponentPrinter1Link2: TdxGridReportLink
      ...
      PrinterPage._dxMeasurementUnits_ = 0
      PrinterPage._dxLastMU_ = 2
      ReportDocument.CreationDate = 44781.816570324070000000
      ShrinkToPageWidth = True
      AssignedFormatValues = [fvDate, fvTime, fvPageNumber]
      OptionsFormatting.UseNativeStyles = True
  ...
  object Qna: TMyQuery
    SQLRefresh.Strings = (
        ...
        'SELECT jenis,waktubayar,kasir,loketbayar,total,keterangan FROM n' +
        'onair '
      'WHERE flaglunas="1" '
      'AND dibebankankepada=:dibebankankepada AND jenis<>"DENDA" '
      'AND YEAR(waktubayar)>=:tahun ORDER BY waktubayar DESC')
    Connection = DM.Conn
    Left = 448
    Top = 216
  end
