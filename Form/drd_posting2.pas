...
var
  udrd_posting2: Tudrd_posting2;

implementation

{$R *.dfm}  uses Module,Dateutils, UnitCombo, UnitMain, RzStatus;

procedure Tudrd_posting2.cxButton1Click(Sender: TObject);
var
keterangan:String;
begin
  ...
  report.LoadFromFile(GetCurrentDir+'\Report\rekapdrdgolongan.fr3');
  ...
  begin
     ...
     exit;
       ...
       TfrxMemoView(report.FindObject('waktuposting')).Memo.Text:='Data Posting <'+FormatDateTime('DD MMM YYYY hh:mm:ss',DM.Qcek.fieldbyname('waktuposting').AsDateTime)+'> oleh <'+DM.Qcek.fieldbyname('user').AsString+'>';
        ...
        Qrek.close;
        Qrek.SQL.clear;
        Qrek.SQL.Add('select c.kodegol,g.golongan,count(c.nosamb) as lembar,SUM(c.pakai) as pakai,SUM(c.biayapemakaian) as biayapemakaian,SUm(c.administrasi) as administrasi,SUm(c.pemeliharaan) as pemeliharaan, SUM(c.retribusi) as retribusi,SUM(c.rekair) as rekair  ');   
...
procedure Tudrd_posting2.FormShow(Sender: TObject);
begin
...
procedure Tudrd_posting2.cxButton2Click(Sender: TObject);
begin
close;
end;

procedure Tudrd_posting2.kodegolPropertiesChange(Sender: TObject);
begin
golongan.ItemIndex:=kodegol.ItemIndex;
end;

procedure Tudrd_posting2.koderayonPropertiesChange(Sender: TObject);
begin
 namarayon.ItemIndex:=koderayon.ItemIndex;
end;

procedure Tudrd_posting2.namarayonPropertiesChange(Sender: TObject);
begin
koderayon.ItemIndex:=namarayon.ItemIndex;
end;

procedure Tudrd_posting2.kodewilPropertiesChange(Sender: TObject);
begin
wilayah.ItemIndex:=kodewil.ItemIndex;
end;

procedure Tudrd_posting2.wilayahPropertiesChange(Sender: TObject);
begin
...
procedure Tudrd_posting2.kodekelurahanPropertiesChange(Sender: TObject);
begin
kelurahan.ItemIndex:=kodekelurahan.ItemIndex;
end;

procedure Tudrd_posting2.kelurahanPropertiesChange(Sender: TObject);
begin
kodekelurahan.ItemIndex:=kelurahan.ItemIndex;
end;

procedure Tudrd_posting2.kodecabangPropertiesChange(Sender: TObject);
begin
cabang.ItemIndex:=kodecabang.ItemIndex;
end;

procedure Tudrd_posting2.cabangPropertiesChange(Sender: TObject);
begin
...
procedure Tudrd_posting2.golonganPropertiesChange(Sender: TObject);
begin
kodegol.ItemIndex:=golongan.ItemIndex;
end;

procedure Tudrd_posting2.FormCreate(Sender: TObject);
begin
periode.date:=EncodeDateTime(YearOf(date), MonthOf(date), 5, 1, 2, 3, 4);
end;

procedure Tudrd_posting2.cekpemakaianClick(Sender: TObject);
begin
  if(cekpemakaian.Checked=true)then
  begin
...
procedure Tudrd_posting2.cekkodegolClick(Sender: TObject);
begin
 if(cekkodegol.Checked=true)then
  begin
...
procedure Tudrd_posting2.cekrayonClick(Sender: TObject);
begin
if(cekrayon.Checked=true)then
  begin
...
procedure Tudrd_posting2.cekwilClick(Sender: TObject);
begin
if(cekwil.Checked=true)then
  begin
...
procedure Tudrd_posting2.cekloketClick(Sender: TObject);
begin
if(cekloket.Checked=true)then
  begin
...
procedure Tudrd_posting2.kodeloketPropertiesChange(Sender: TObject);
begin
loket.ItemIndex:=kodeloket.ItemIndex;
end;

procedure Tudrd_posting2.loketPropertiesChange(Sender: TObject);
begin
kodeloket.ItemIndex:=loket.ItemIndex;
end;

procedure Tudrd_posting2.cekbayarClick(Sender: TObject);
begin
  if(cekbayar.Checked=true)then
  begin
      bayar.Enabled:=true;
...
procedure Tudrd_posting2.cekkolektifClick(Sender: TObject);
begin
if(cekkolektif.Checked=true)then
  begin
...
procedure Tudrd_posting2.kodekolektifPropertiesChange(Sender: TObject);
begin
kolektif.ItemIndex:=kodekolektif.ItemIndex;
end;

procedure Tudrd_posting2.kolektifPropertiesChange(Sender: TObject);
begin
kodekolektif.ItemIndex:=kolektif.ItemIndex;
end;

procedure Tudrd_posting2.F5Execute(Sender: TObject);
begin
  report.LoadFromFile(GetCurrentDir+'\report\rekapdrdgolongan.fr3');
  report.DesignReport(true);
end;

procedure Tudrd_posting2.cekcabangClick(Sender: TObject);
begin
...
procedure Tudrd_posting2.kodeareaPropertiesChange(Sender: TObject);
begin
area.ItemIndex:=kodearea.ItemIndex;
end;

procedure Tudrd_posting2.areaPropertiesChange(Sender: TObject);
begin
kodearea.ItemIndex:=area.ItemIndex;
end;

procedure Tudrd_posting2.cekareaClick(Sender: TObject);
begin
if(cekarea.Checked=true)then
  begin
...
procedure Tudrd_posting2.kodeflagPropertiesChange(Sender: TObject);
begin
flag.ItemIndex:=kodeflag.ItemIndex;
end;

procedure Tudrd_posting2.flagPropertiesChange(Sender: TObject);
begin
kodeflag.ItemIndex:=flag.ItemIndex;
end;

procedure Tudrd_posting2.cekflagClick(Sender: TObject);
begin
if(cekflag.Checked=true)then
  begin
