...
procedure Tulppharian3.cxButton2Click(Sender: TObject);
begin
close;
end;

procedure Tulppharian3.cxButton1Click(Sender: TObject);
var
keterangan:String;
begin

  report.LoadFromFile(GetCurrentDir+'\Report\rekaplppairpertanggal.fr3');
 ...
 begin
  ...
  Qrek.SQL.Add('GROUP BY CONCAT(c.loketbayar,".",DATE(c.tglbayar)) ASC');
...
procedure Tulppharian3.FormCreate(Sender: TObject);
begin
periode.date:=EncodeDateTime(YearOf(date), MonthOf(date), 5, 1, 2, 3, 4);
end;

procedure Tulppharian3.F5Execute(Sender: TObject);
begin
report.LoadFromFile(GetCurrentDir+'\report\rekaplppairpertanggal.fr3');
  report.DesignReport(true);
end;

procedure Tulppharian3.cekkasirClick(Sender: TObject);
begin
  if(cekkasir.Checked=true)then
  begin
      kasir.Enabled:=true;
...
procedure Tulppharian3.cekshiftClick(Sender: TObject);
begin
 if(cekshift.Checked=true)then
  begin
      shift.Enabled:=true;
...
procedure Tulppharian3.FormShow(Sender: TObject);
begin
ucombo.isikombo();
...
procedure Tulppharian3.cekgolClick(Sender: TObject);
begin
 if(cekgol.Checked=true)then
  begin
...
procedure Tulppharian3.kodegolPropertiesChange(Sender: TObject);
begin
golongan.ItemIndex:=kodegol.ItemIndex;
end;

procedure Tulppharian3.golonganPropertiesChange(Sender: TObject);
begin
...
procedure Tulppharian3.cekwilClick(Sender: TObject);
begin
if(cekwil.Checked=true)then
  begin
...
procedure Tulppharian3.kodewilPropertiesChange(Sender: TObject);
begin
wilayah.ItemIndex:=kodewil.ItemIndex;
end;

procedure Tulppharian3.wilayahPropertiesChange(Sender: TObject);
begin
kodewil.ItemIndex:=wilayah.ItemIndex;
end;

procedure Tulppharian3.cekketeranganClick(Sender: TObject);
begin
  if(cekketerangan.Checked=true)then
  begin
...
procedure Tulppharian3.cekwilloketClick(Sender: TObject);
begin
if(cekwilloket.Checked=true)then
  begin
...
procedure Tulppharian3.kodewil2PropertiesChange(Sender: TObject);
begin
wilayah2.ItemIndex:=kodewil2.ItemIndex;
end;

procedure Tulppharian3.wilayah2PropertiesChange(Sender: TObject);
begin
kodewil2.ItemIndex:=wilayah2.ItemIndex;
end;

procedure Tulppharian3.cekloketClick(Sender: TObject);
begin
 if(cekloket.Checked=true)then
  begin
...
procedure Tulppharian3.kodeloketPropertiesChange(Sender: TObject);
begin
loket.ItemIndex:=kodeloket.ItemIndex;
end;

procedure Tulppharian3.loketPropertiesChange(Sender: TObject);
begin
