object FRpelangganlimbah: TFRpelangganlimbah
  Left = 0
  Top = 0
  Width = 1571
  Height = 689
    ...
    object GridPel: TcxGrid
      ...
      object GTVpel: TcxGridDBTableView
        ...
        object GTVpelColumn16: TcxGridDBColumn
          Caption = 'Nm. Limbah'
          DataBinding.FieldName = 'golonganlimbah'
          Visible = False
          HeaderAlignmentHorz = taCenter
          Width = 159
        end
  ...
  object RzSizePanel2: TRzSizePanel
    ...
    object cxScrollBox4: TcxScrollBox
      ...
      object RzPanel3: TRzPanel
        ...
        object ceknolimbah: TcxCheckBox
          Left = 8
          Top = 122
          Caption = 'No.Limbah'
          ParentFont = False
          ...
          TabOrder = 32
          Transparent = True
          OnClick = ceknolimbahClick
          Width = 89
        end
        object nomorlimbah: TcxTextEdit
          Left = 96
          Top = 122
          Enabled = False
          ParentFont = False
  ...
  object RzPanel10: TRzPanel
    ...
    Align = alTop
    BorderOuter = fsNone
    Caption = 'DAFTAR PELANGGAN LIMBAH'
    Color = 20966
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -12
  ...
  object Qpel: TMyQuery
    ...
    object Qpelnomorlimbah: TStringField
      FieldName = 'nomorlimbah'
      Size = 50
    end
    ...
    object Qpelkodelimbah: TStringField
      FieldName = 'kodelimbah'
      Size = 50
    end
    ...
    object Qpelgolonganlimbah: TStringField
      FieldName = 'golonganlimbah'
      Size = 100
    end
  ...
  object Qpelmain: TMyQuery
    SQLRefresh.Strings = (
      ...
      'LEFT JOIN kolektif k ON p.kodekolektif=k.kodekolektif'
        ...
        'kodelimbah) g ON p.kodelimbah=g.kodelimbah'
      'LEFT JOIN flag f ON p.`flag`=f.`kodeflag`'
      'WHERE p.nomorlimbah=:nomorlimbah')
    SQLLock.Strings = (
      'SELECT '
      'p.*,'
      'f.uraian AS flagpel,'
  ...
  object PopupMenu1: TPopupMenu
    ...
    object PerbaruiDataRekening1: TMenuItem
      Caption = 'Perbarui Data Rekening'
      ImageIndex = 11
      OnClick = PerbaruiDataRekening1Click
    end
