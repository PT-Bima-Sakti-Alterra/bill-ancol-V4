object uterbitkanlltt: Tuterbitkanlltt
  Left = 936
  Top = 194
  BorderIcons = []
  BorderStyle = bsNone
  ...
  object RzPanel1: TRzPanel
    ...
    object info: TRzPanel
      ...
      BorderOuter = fsNone
      BorderColor = clBlack
      Caption = 'TERBITKAN PELANGGAN L2T2'
      Color = 20966
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWhite
      Font.Height = -13
  ...
  object Qpelmain: TMyQuery
    SQLRefresh.Strings = (
        ...
        'SELECT p.nomorlltt,p.nosamb,p.nama,p.alamat,p.koderayon,r.kodewi' +
        'l,p.kodekelurahan,y.kodecabang,p.kodelltt,p.kodekolektif,'
      ''
      'CASE p.status'
      ' WHEN 1 THEN "Aktif"'
      ...
      ''
        ...
        'FROM dump111 z LEFT JOIN pelanggan_lltt p ON z.nomorlltt=p.nomor' +
        'lltt '
      ...
      'LEFT JOIN kelurahan Y ON p.kodekelurahan=y.kodekelurahan'
        ...
        'WHERE z.nomorlltt  NOT IN (SELECT nomorlltt FROM dump222) AND p.' +
        'status<>"0"'
      'ORDER BY CAST(z.nomorlltt AS UNSIGNED) ASC')
    Connection = DM.Conn
    Left = 128
    Top = 328
  end
  object Qcek: TMyQuery
    SQLRefresh.Strings = (
      ...
      '  FROM'
      '  dump111 z '
      '  LEFT JOIN pelanggan_lltt p ON z.nomorlltt = p.nomorlltt  '
      ...
      ''
        ...
        '  WHERE z.flag = "1" AND z.nomorlltt NOT IN (SELECT nomorlltt FR' +
        'OM dump222)')
    Connection = DM.Conn
    Left = 392
    Top = 224
  ...
  object dxComponentPrinter1: TdxComponentPrinter
    ...
    object dxComponentPrinter1Link1: TdxGridReportLink
      ...
      ReportDocument.CreationDate = 43775.675573090280000000
