...
type
  Turubahgolonganlimbah = class(TForm)
    RzPanel1: TRzPanel;
    ok: TcxButton;
    no: TcxButton;
    cxLabel1: TcxLabel;
...
var
  urubahgolonganlimbah: Turubahgolonganlimbah;
...
procedure Turubahgolonganlimbah.noClick(Sender: TObject);
begin
close;
end;

procedure Turubahgolonganlimbah.okClick(Sender: TObject);
begin
...
procedure Turubahgolonganlimbah.FormShow(Sender: TObject);
begin
      ucombo.isikombo();
      kodebaru.properties.items:= Ucombo.kodelimbah.properties.items;
      kodebaru.Focused;
end;
