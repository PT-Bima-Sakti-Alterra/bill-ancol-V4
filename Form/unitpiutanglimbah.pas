...
var
  upiutanglimbah: Tupiutanglimbah;

implementation

{$R *.dfm} uses Module;

procedure Tupiutanglimbah.refreshClick(Sender: TObject);
begin
  Qrek.close;
  Qrek.SQL.Clear;
  Qrek.SQL.Add(Qrek.SQLRefresh.Text);
  Qrek.ParamByName('nomorlimbah').AsString:=DM.xnomorlimbah;
  Qrek.Open;
end;

procedure Tupiutanglimbah.Action1Execute(Sender: TObject);
begin
close;
end;
