...
procedure Turubahalamat.noClick(Sender: TObject);
begin
close;
end;

procedure Turubahalamat.FormShow(Sender: TObject);
begin
      ucombo.isikombo();
...
procedure Turubahalamat.koderayonbaruPropertiesChange(Sender: TObject);
begin
...
procedure Turubahalamat.okClick(Sender: TObject);
begin
