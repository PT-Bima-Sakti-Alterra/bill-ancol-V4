...
procedure TFRrablainnya.tampilkanClick(Sender: TObject);
var
i:integer;
begin
TRY
...
procedure TFRrablainnya.hapusClick(Sender: TObject);
begin
...
procedure TFRrablainnya.ceknomorClick(Sender: TObject);
begin
 if(ceknomor.Checked=true)then
  begin
      xnomor.Enabled:=true;
...
procedure TFRrablainnya.ceknamaClick(Sender: TObject);
begin
 if(ceknama.Checked=true)then
  begin
      xnama.Enabled:=true;
...
procedure TFRrablainnya.cekinputClick(Sender: TObject);
begin
 if(cekinput.Checked=true)then
  begin
...
procedure TFRrablainnya.tambahClick(Sender: TObject);
begin
...
procedure TFRrablainnya.KoreksiClick(Sender: TObject);
begin
...
procedure TFRrablainnya.CetakRAB1Click(Sender: TObject);
begin
...
procedure TFRrablainnya.CetakBPPI1Click(Sender: TObject);
begin
...
procedure TFRrablainnya.CetakSPPB1Click(Sender: TObject);
var
romawi:String;
_nomorsppb:String;
begin
...
procedure TFRrablainnya.CetakSPKPemasangan1Click(Sender: TObject);
var
romawi:String;
_nomorspkp:String;
begin
...
procedure TFRrablainnya.BAP1Click(Sender: TObject);
var
romawi:String;
_nomorbapb:String;
begin
...
procedure TFRrablainnya.BuatBeritaAcarapemasangan1Click(Sender: TObject);
var
romawi:String;
_nomorbap:String;
begin
...
procedure TFRrablainnya.PembatalanRAB1Click(Sender: TObject);
begin
...
procedure TFRrablainnya.SetSudahLunas1Click(Sender: TObject);
begin
  if(Qhost.RecordCount=0)then
    begin
        MessageDlg('Tidak ada data !!', mtWarning, [MbOk], 0);
...
procedure TFRrablainnya.CetakBAP1Click(Sender: TObject);
begin
  if(data_.RecordCount>0)then
  begin
...
procedure TFRrablainnya.gridCustomDrawCell(
...
procedure TFRrablainnya.RAB1Click(Sender: TObject);
begin
  rab.LoadFromFile(GetCurrentDir+'\report\rablainnya.fr3');
  rab.DesignReport(true);
end;

procedure TFRrablainnya.BPPI1Click(Sender: TObject);
begin
 bppi.LoadFromFile(GetCurrentDir+'\report\bppilainnya.fr3');
  bppi.DesignReport(true);
end;

procedure TFRrablainnya.SPK1Click(Sender: TObject);
begin
 spkp.LoadFromFile(GetCurrentDir+'\report\spkplainnya.fr3');
 spkp.DesignReport(true);
end;

procedure TFRrablainnya.SPPB1Click(Sender: TObject);
begin
   sppb.LoadFromFile(GetCurrentDir+'\report\sppblainnya.fr3');
  sppb.DesignReport(true);
end;

procedure TFRrablainnya.BAPB1Click(Sender: TObject);
begin
 bapb.LoadFromFile(GetCurrentDir+'\report\bapblainnya.fr3');
  bapb.DesignReport(true);
end;

procedure TFRrablainnya.BAP2Click(Sender: TObject);
begin
 baptemp.LoadFromFile(GetCurrentDir+'\report\baplainnyatemporari.fr3');
  baptemp.DesignReport(true);
end;

procedure TFRrablainnya.BAP3Click(Sender: TObject);
begin
 bap.LoadFromFile(GetCurrentDir+'\report\baplainnya.fr3');
  bap.DesignReport(true);
end;

procedure TFRrablainnya.xkodewilPropertiesChange(Sender: TObject);
begin
xwilayah.ItemIndex:=xkodewil.ItemIndex;
end;

procedure TFRrablainnya.xwilayahPropertiesChange(Sender: TObject);
begin
xkodewil.ItemIndex:=xwilayah.ItemIndex;
end;

procedure TFRrablainnya.cekwilClick(Sender: TObject);
begin
if(cekwil.Checked=true)then
  begin
...
procedure TFRrablainnya.cekalamatClick(Sender: TObject);
begin
if(cekalamat.Checked=true)then
  begin
...
procedure TFRrablainnya.gridCellDblClick(
...
procedure TFRrablainnya.cxButton1Click(Sender: TObject);
begin
...
procedure TFRrablainnya.cektanggalbaClick(Sender: TObject);
begin
if(cektanggalba.Checked=true)then
  begin
...
procedure TFRrablainnya.UploadDenah1Click(Sender: TObject);
var
app:string;
begin
...
procedure TFRrablainnya.CetakDenah1Click(Sender: TObject);
var
    a:TStream;
    jpg:TJpegImage;
begin
...
procedure TFRrablainnya.ceknosambClick(Sender: TObject);
begin
if(ceknosamb.Checked=true)then
  begin
...
procedure TFRrablainnya.KoreksiRKP1Click(Sender: TObject);
begin
...
procedure TFRrablainnya.BuatSuratPermintaanPengambilanBarangSPPB1Click(
  Sender: TObject);
var
romawi:String;
_nomorsppb:String;
...
procedure TFRrablainnya.Denah1Click(Sender: TObject);
begin
   denah.LoadFromFile(GetCurrentDir+'\report\denahlainnya.fr3');
