...
var
  urubahalamatlltt: Turubahalamatlltt;
...
procedure Turubahalamatlltt.noClick(Sender: TObject);
begin
close;
end;

procedure Turubahalamatlltt.FormShow(Sender: TObject);
begin
      ucombo.isikombo();
...
procedure Turubahalamatlltt.koderayonbaruPropertiesChange(Sender: TObject);
begin
...
procedure Turubahalamatlltt.okClick(Sender: TObject);
begin
